...
export default function createClient(endpointParam, credentials, _a = {}) {
    ...
    var { apiVersion = "2023-10-01" } = _a, options = __rest(_a, ["apiVersion"]);
    const endpointUrl = (_c = (_b = options.endpoint) !== null && _b !== void 0 ? _b : options.baseUrl) !== null && _c !== void 0 ? _c : `${endpointParam}/computervision`;
